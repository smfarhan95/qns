...
if(isset($_POST['submit'])){
    if ($_POST['fname']==""||$_POST['icno']==""||$_POST['id']==""||$_POST['address']==""||$_POST['gender']==""||$_POST['contact']=="") {
        ?><script>alert("Please insert all data!");</script><?php
    }
    else{
        $sql = "insert into staff (staff_Name,staff_IC,staff_Id,staff_Address,staff_Sex,staff_Phone,staff_Password) values ('$_POST[fname]','$_POST[icno]','$_POST[id]','$_POST[address]','$_POST[gender]','$_POST[contact]','123')";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form role="form" method="post" action="staff-reg.php">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="id" autocomplete="false">
                                            <p class="help-block">Example: S0012.</p>
                                        </div>
                                        <div class="form-group">
